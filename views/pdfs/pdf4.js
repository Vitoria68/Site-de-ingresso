...
doc.pipe(fs.createWriteStream('marisa.pdf'))

// Fundo 
doc.rect(0, 0, 900, 300).fill('white');
...
doc
  ...
  // Endereço e produção
doc.fillColor('#B03060').fontSize(12).font('Helvetica');
doc.text('Av. Pedro Álvares Cabral, s/n - Vila Mariana', 60, 50, { align: 'center', width: 660 });
doc.text('PRODUÇÃO DE STUDIO SANTANA', 60, 65, { align: 'center', width: 660 });

// Nome da artista
doc.font('Helvetica-BoldOblique').fontSize(47).fillColor('#FF1493');
doc.text('MARISA MONTE ', 76, 150, { align: 'center', width: 660 });

// Data
doc.fontSize(16).fillColor('#B03060');
doc.text('08', 90, 123, { align: 'left' }).font('Helvetica-Bold');
...
doc
  .fillColor('#FF4500').fillOpacity(0.2)
  .rect(650, 85, 200, 20)
  .fill();
  doc.fillColor('#B03060')
  .fillOpacity(1);
...
doc.font('Helvetica').fontSize(9).text('PARQUE IBIRAPUERA', 700, 110);
doc.text('08 DE NOVEMBRO', 700, 125);
