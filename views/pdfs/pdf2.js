...
doc.pipe(fs.createWriteStream('mcr.pdf'))
...
// Nome da artista
doc.font('Helvetica-BoldOblique').fontSize(27).fillColor('#800000');
doc.text('MY CHEMICAL ROMANCE ', 76, 150, { align: 'center', width: 660 });

// Data
doc.fontSize(16).fillColor('#f8f8ff');
doc.text('05', 90, 123, { align: 'left' }).font('Helvetica-Bold');
doc.fontSize(13).text('FEVEREIRO', 115, 125);
...
doc.text('05 DE FEVEREIRO', 700, 125);
